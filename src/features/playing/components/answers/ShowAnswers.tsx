...
import { useAnimationEffects } from "../../hooks/answers/useAnimationEffects";
import { useAnswerStyles } from "../../hooks/answers/useAnswerStyles";
import { useShouldShowIndicator } from "../../hooks/answers/useShouldShownIndicator";
import AnswerIndicator from "./AnswerIndicator";
import { AnswerCheckbox } from "./AnswerCheckbox";
import { useDimmedLogic } from "../../hooks/answers/useDimmedLogic";
import { useAnimationState } from "../../hooks/answers/useAnimationState";
...
interface ShowAnswersProps {
  ...
  isPause?: boolean;
  isLast: boolean;
  animationComplete: (value: boolean) => void;
}
...
const ShowAnswers = ({
    ...
    () => ({
      ...
      [ANIMATION_STATES.ANIMATE]: {
        ...
        transition: {
          ...
          delay:
            ANIMATION_CONFIG.baseDelay + index * ANIMATION_CONFIG.indexDelay,
        },
      },
  ...
  const handleAnimationComplete = () => {
    ...
    if (
      animationState === ANIMATION_STATES.ANIMATE &&
      isLast &&
      !question.media
    ) {
  ...
  return (
    ...
    >
      <div className="flex items-center">
        <AnswerCheckbox questionType={questionType} isSelected={isSelected} />
